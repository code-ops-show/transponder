...
module Transponder
  module Generators
    class InstallGenerator < Base
      ...
      def add_setup
        template 'setup.coffee', "app/assets/javascripts/#{js_app_name}-setup.js.coffee"
      end 

      def add_manifest
        template 'manifest.coffee', "app/assets/javascripts/#{js_app_name}-manifest.js.coffee"
      end
    end
  end
end