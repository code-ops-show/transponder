# Transponder
[![Build Status](https://travis-ci.org/xpdr/transponder.png?branch=develop)](https://travis-ci.org/artellectual/transponder) [![Gem Version](https://badge.fury.io/rb/transponder.png)](http://badge.fury.io/rb/transponder) [![Coverage Status](https://coveralls.io/repos/codemy/transponder/badge.png?branch=develop)](https://coveralls.io/r/codemy/transponder?branch=develop) [![Code Climate](https://codeclimate.com/github/xpdr/transponder.png)](https://codeclimate.com/github/xpdr/transponder)
